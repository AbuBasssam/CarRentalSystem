...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260102075523_AddOutboxMessages")]
            ...
            modelBuilder.Entity("Domain.Entities.OutboxMessage", b =>
                {
                    ...
                    b.ToTable("OutboxMessages", null, t =>
                        {
                            t.HasCheckConstraint("CK_OutboxMessage_Status", "Status IN (1, 2, 3)");

                            t.HasCheckConstraint("CK_OutboxMessage_Type", "Type IN (1, 2)");
                        });
                });
